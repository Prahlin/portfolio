...
function CaseTablet({
  ...
  return (
    <div
      className={`av-device av-device-${aspect} cinerific-tablet-device ${className}`}
    >
      <div className="cinerific-tablet-camera" />
      <div className="av-device-screen cinerific-tablet-screen" />
    </div>
  );
}

export default function CinerificCaseStudy() {
  return (
    <main className="project-page cinerific-case">
      <section className="project-hero" id="top">
        <div className="site-shell">
          ...
          <div className="project-hero-grid">
            ...
            <div className="av-showcase" aria-label="Cinerific app screens">
              <CaseTablet
                aspect="tall"
        ...
        <div className="site-shell project-section-grid">
          ...
          <div>
            <div
              ...
              aria-label="Cinerific technical architecture"
            >
        ...
        <div className="site-shell readiness-layout">
          ...
          <div>
            <p className="readiness-copy">
              Cinerific was not treated as a static concept piece. The work
